...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-[#DC2626] flex text-black font-sans">
            ...
            {/* Right Side - Form - Red */}
            <div className="w-full xl:w-2/3 flex items-center justify-center p-6 sm:p-8 lg:p-24 bg-[#DC2626] overflow-y-auto">
                <div className="max-w-2xl w-full mt-16 xl:mt-0">
                    ...
                    <div className="mb-12">
                        <h2 className="text-3xl lg:text-4xl font-black uppercase tracking-widest mb-2 text-black">Initialize Account</h2>
